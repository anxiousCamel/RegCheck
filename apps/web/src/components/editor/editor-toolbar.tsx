  ...
  return (
    <div className="flex items-center gap-2 p-1.5 bg-white/90 backdrop-blur-xl border border-slate-200 rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.08)] max-w-[90vw] sm:max-w-none overflow-x-auto scrollbar-hide">
        ...
        {TOOLS.map((tool) => {
          ...
          return (
            ...
            >
              ...
              />
              <span className="text-[11px] font-black uppercase tracking-tight hidden md:inline">
                {tool.label}
              </span>
            </button>
          );
      ...
      >
        ...
        <span className="text-[11px] font-black uppercase tracking-tight hidden lg:inline text-current">
          Grid
        </span>
      </button>
