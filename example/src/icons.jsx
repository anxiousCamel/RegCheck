...
const IconScale = (p) => (
  <Icon
    ...
    d={
      <>
        <path d="M12 3v18" />
        <path d="M5 8l-3 6a6 6 0 0 0 6 6 6 6 0 0 0 6-6l-3-6" />
        <path d="M19 8l-3 6a6 6 0 0 0 6 0l-3-6" />
        <path d="M5 3h14" />
      </>
    }
  />
...
const IconSignature = (p) => (
  <Icon
    {...p}
    d={
      <>
        <path d="M3 17s2-3 5-3 5 3 8 3 4-2 5-3" />
...
const IconFlash = (p) => (
  <Icon {...p} d={<polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" />} />
);
const IconRotate = (p) => (
  <Icon
    {...p}
