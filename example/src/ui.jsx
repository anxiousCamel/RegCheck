...
function StatusChip({ status }) {
  if (status === 'done')
    return (
      <Badge variant="success" icon={<IconCheck size={12} strokeWidth={3} />}>
        Concluído
      </Badge>
    );
          ...
          return (
            <button
              ...
              style={{
                ...
                borderRadius: 10,
                border: active
                  ? '2px solid var(--rc-primary)'
                  : '1px solid var(--rc-border-strong)',
            ...
            >
              ...
              >
                {active && opt.v === true && (
                  <IconCheck size={12} stroke="#fff" strokeWidth={3.5} />
                )}
                {active && opt.v === false && (
                  <IconX size={12} stroke="var(--rc-primary)" strokeWidth={3.5} />
                )}
              </span>
              {opt.label}
            </button>
