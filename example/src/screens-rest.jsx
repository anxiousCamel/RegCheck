  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        margin:'0 14px', borderRadius:18, overflow:'hidden',
        background:'linear-gradient(145deg, #0f172a, #1e293b 50%, #334155)',
      }}>
        {/* "live" viewport */}
        <svg width="100%" height="100%" viewBox="0 0 380 560" style={{position:'absolute',inset:0}} preserveAspectRatio="xMidYMid slice">
          <defs>
          ...
          <g transform="translate(60, 140)">
            <rect x="0" y="0" width="260" height="240" rx="6" fill="#475569" stroke="#64748b" strokeWidth="1"/>
            ...
            <g transform="translate(30, 170)">
              {[0,1,2,3].map(r => [0,1,2,3].map(c => (
                <rect key={`${r}-${c}`} x={c*48} y={r*14} width="40" height="10" rx="2" fill="rgba(255,255,255,0.15)"/>
              )))}
            </g>
          </g>
        ...
        <div style={{
          ...
          width:70, height:70, border:'1.5px solid #FACC15',
          borderRadius:4, animation: 'rc-pulse 1.6s ease-in-out infinite',
        }}/>
  ...
  return (
    <div style={{background:'var(--rc-bg)', minHeight:'100%'}}>
      ...
      <div style={{padding:14}}>
        <div style={{fontSize:13, color:'var(--rc-fg-muted)', marginBottom:12, lineHeight:1.5}}>
          Assine no espaço abaixo. O responsável confirma que a preventiva do PDV-04 foi realizada conforme o checklist.
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              fontSize:11, color:'var(--rc-fg-subtle)', fontWeight:500,
              pointerEvents:'none',
            }}>
              X ─────────────────────────────
            </div>
            {!hasInk && (
              <div style={{
                position:'absolute', inset:0,
                display:'flex', alignItems:'center', justifyContent:'center',
                color:'var(--rc-fg-subtle)', fontSize:13, pointerEvents:'none',
                fontStyle:'italic',
              }}>
      ...
      <div style={{
        ...
        <button className="rc-btn rc-btn--outline rc-btn--lg" style={{flex:1}} onClick={onCancel}>
          Cancelar
        </button>
        <button className="rc-btn rc-btn--lg" style={{flex:2}}
                disabled={!hasInk} onClick={onDone}>
          <IconCheck size={18}/>
  ...
  return (
    <div style={{background:'var(--rc-bg)', minHeight:'100%'}}>
      ...
      <div style={{padding:14, display:'flex', flexDirection:'column', gap:14}}>
        ...
        <div style={{
          background:'#fff', borderRadius:14,
          border:'1px solid var(--rc-border)', boxShadow:'var(--rc-shadow-sm)',
          padding:14,
        }}>
          ...
          <div style={{marginTop:10}}>
            <ProgressBar value={done} max={MOCK_DOC.totalItems} showLabel
          ...
          <div style={{display:'flex', flexDirection:'column', gap:8}}>
            {MOCK_DOC.setores.map(s => (
              <div key={s.id} style={{
                ...
                {s.done === s.count ? (
                  <Badge variant="success" icon={<IconCheck size={11} strokeWidth={3.5}/>}>OK</Badge>
                ) : (
      ...
      <div style={{
        ...
        <button className="rc-btn rc-btn--outline rc-btn--lg" style={{flex:'0 0 56px', padding:0}}
                onClick={onBack}><IconChevronLeft size={20}/></button>
...
function Metric({ label, value, color, muted }) {
  return (
    <div>
      ...
      <div style={{fontSize:11, color:'var(--rc-fg-muted)', fontWeight:600, marginTop:4, letterSpacing:'0.02em', textTransform:'uppercase'}}>
        {label}
      </div>
    </div>
  );
...
function ScreenSuccess({ onStart, onDownload }) {
  ...
  return (
    <div style={{
      background:'var(--rc-bg)', minHeight:'100%',
      display:'flex', flexDirection:'column',
      ...
      {phase === 'generating' && (
        <div style={{flex:1, display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', gap:18}}>
          ...
          <div style={{textAlign:'center'}}>
            <div style={{fontSize:20, fontWeight:700, letterSpacing:'-0.01em'}}>Gerando PDF…</div>
            <div style={{fontSize:13, color:'var(--rc-fg-muted)', marginTop:6, maxWidth:280, lineHeight:1.5}}>
      ...
      {phase === 'done' && (
        <>
          <div style={{flex:1, display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', gap:16}}>
            ...
            <div style={{textAlign:'center'}}>
              <div style={{fontSize:22, fontWeight:800, letterSpacing:'-0.02em'}}>Preventiva concluída</div>
              <div style={{fontSize:13, color:'var(--rc-fg-muted)', marginTop:6, maxWidth:300, lineHeight:1.5}}>
                O PDF de {MOCK_DOC.name} está pronto. Você pode baixar, compartilhar ou iniciar uma nova preventiva.
              </div>
            </div>
            ...
            <div style={{
              ...
              padding:12, width:'100%', maxWidth:320,
              display:'flex', alignItems:'center', gap:12,
            }}>
              <div style={{
                ...
                <div style={{
                  fontSize:9, fontWeight:800, color:'var(--rc-primary)',
                  letterSpacing:'0.05em',
                }}>PDF</div>
                {/* stripes */}
                <div style={{position:'absolute', inset:'6px 6px 18px', display:'flex', flexDirection:'column', gap:3}}>
                  {[0.9, 0.7, 0.85, 0.5, 0.75].map((w,i)=>(
                    <div key={i} style={{height:2, width:`${w*100}%`, background:'var(--rc-border-strong)', borderRadius:1}}/>
                  ))}
                </div>
              </div>
