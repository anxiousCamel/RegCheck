 ...
 */
export function validateContent(content: string, _filename?: string): ContentValidationResult {
 ...
 */
export function validateContentInFiles(
  files: Array<{ path: string; content: string }>,
): Map<string, ContentValidationResult> {
