 ...
 */
function extractMermaidDiagrams(content: string): Array<{ type: string; content: string; line: number }> {
 ...
 */
function validateSingleDiagram(diagram: { type: string; content: string; line: number }): MermaidValidationError[] {
  const errors: MermaidValidationError[] = [];
 ...
 */
function validateERDiagram(diagram: { type: string; content: string; line: number }): MermaidValidationError[] {
  const errors: MermaidValidationError[] = [];
 ...
 */
function validateGraphDiagram(diagram: { type: string; content: string; line: number }): MermaidValidationError[] {
  const errors: MermaidValidationError[] = [];
  const lines = diagram.content.split('\n');
 ...
 */
function validateSequenceDiagram(diagram: { type: string; content: string; line: number }): MermaidValidationError[] {
  const errors: MermaidValidationError[] = [];
  const lines = diagram.content.split('\n');
 ...
 */
export function validateMermaidInFiles(files: Array<{ path: string; content: string }>): Map<string, MermaidValidationResult> {
