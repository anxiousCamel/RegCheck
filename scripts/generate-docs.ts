...
async function main() {
  ...
  try {
    ...
    console.log(`   ✓ Found ${prismaOutput.data.models.length} models, ${prismaOutput.data.enums.length} enums\n`);
    ...
    console.log(`   ${dataModelResult.written ? '✓ Written' : '○ Skipped'}: ${dataModelResult.filepath}\n`);
    ...
    console.log(`   ${apiRefResult.written ? '✓ Written' : '○ Skipped'}: ${apiRefResult.filepath}\n`);
    ...
    console.log(`   ${errorCodesResult.written ? '✓ Written' : '○ Skipped'}: ${errorCodesResult.filepath}\n`);
